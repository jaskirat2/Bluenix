...
public class MyHistoryAdapter extends RecyclerView.Adapter<MyHistoryAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, int i) {
        ...
        myViewHolder.txt_booking_barber_text.setText(bookingInformationList.get(i).getRoomName());
        myViewHolder.txt_booking_time_text.setText(bookingInformationList.get(i).getTime());
        myViewHolder.txt_salon_address.setText(bookingInformationList.get(i).getStudioAddress());
        myViewHolder.txt_salon_name.setText(bookingInformationList.get(i).getStudioName());
