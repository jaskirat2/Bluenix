...
import in.techaddicts.bluenix.Fragment.HomeFragment;
import in.techaddicts.bluenix.Fragment.ShopingFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent() != null)
        {
            ...
            if (isLogin)
            {
                ...
                Paper.book().write(Common.LOGGED_KEY,user.getPhoneNumber().toString());              //Check from 33rd video....
                            ...
                            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                                if (task.isSuccessful()) {
                                    ...
                                    if (!userSnapShot.exists()) {
                                        ...
                                        HomeActivity.this.showUpdateDialog(user.getPhoneNumber());
                                    } else {
