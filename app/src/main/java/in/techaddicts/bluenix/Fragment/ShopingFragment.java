...
import in.techaddicts.bluenix.Adapter.MyShoppingItemAdapter;
import in.techaddicts.bluenix.Common.SpacesItemDecoration;
import in.techaddicts.bluenix.Interface.IShoppingDataLoadListener;
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
              if(task.isSuccessful())
              {
                  ...
                  for(DocumentSnapshot itemSnapShot : task.getResult())
                  {
                      ...
                      shoppingItem.setId(itemSnapShot.getId());    //Remember add it if you dont want to get null reference...
